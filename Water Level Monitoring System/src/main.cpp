...
const int numReadings = 10; // Number of readings to collect for moving average
unsigned int readings[numReadings]; // Array to store readings
unsigned int readIndex = 0; // Index for storing readings
unsigned long total = 0; // Total sum of readings

long duration;
long distance;
float waterHeight;
float tankHeight = 304;
float tankLength = 477;
float tankBreath = 353;
float tankVolume = 51187824;
float waterQuantity;
float volume;
...
// data-channel-id="2462587" data-api-key="3PPG5KKQT8O9PODH" channel 1
// data-channel-id="2537708" data-api-key="V3FKYPWX1M8PCICU" channel 2
// data-channel-id="2537713" data-api-key="8AWZWOM6D7LVHL7L" channel 3
// data-channel-id="2465169" data-api-key="YWNX16X7HGN7068D" for checking data receving
const char *thingSpeakAddress = "api.thingspeak.com";
const char* apiKey = "YWNX16X7HGN7068D";
const unsigned long channelID = 2465169;
...
void ultrasonic() {
  unsigned int averageDistance = movingAverage();

  volume = 168381 * averageDistance;
  waterHeight = tankHeight - averageDistance;
